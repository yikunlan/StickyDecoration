...
public class XinlangStickyDecoration extends BaseXinlangDecoration {

    private PowerGroupListener mGroupListener;

    private Paint mGroutPaint;

    private XinlangStickyDecoration(PowerGroupListener groupListener) {
        super();
    ...
    public static class Builder {
        XinlangStickyDecoration mDecoration;

        private Builder(PowerGroupListener listener) {
            mDecoration = new XinlangStickyDecoration(listener);
        }
        ...
        public XinlangStickyDecoration build() {
            return mDecoration;
        }
    }
